...
class _SurveyPageState extends State<SurveyPage> {
  ...
  final _questions = const [
    ...
    },
    {
      ...
      'answers': [
        ...
        {
          'text':
              'I was working hard to ensure adequate hydration and water consumption, but have not been prioritizing it lately.',
          'score': 6,
          'yesFlag': false
        },
    ...
    },
    {
      ...
      'answers': [
        {'text': 'Rarely', 'score': 1, 'yesFlag': false},
        ...
        {
          'text': 'Every day for the past 6 months+',
          'score': 5,
          'yesFlag': false
        },
        {
          'text': 'This used to affect me, but no longer does',
          'score': 6,
          'yesFlag': false
        },
        {'text': 'Previous Question', 'score': 0, 'yesFlag': true},
    ...
    },
    {
      ...
      'answers': [
        {
          'text':
              'I am not interested in maintaining adequate nutrition right now.',
          'score': 1,
          'yesFlag': false
        },
        {
          'text':
              'I have been interested in learning more about or improving my nutrient intake and balance.',
          'score': 2,
          'yesFlag': false
        },
        {
          'text':
              'I have been thinking about ways to achieve adequate nutrient intake and balance.',
          'score': 3,
          'yesFlag': false
        },
        {
          'text':
              'I have started improving my nutrient intake and balance in the last six months.',
          'score': 4,
          'yesFlag': false
        },
        {
          'text':
              'I have been ensuring adequate nutrient intake and balance for over six months and plan to continue to do so.',
          'score': 5,
          'yesFlag': false
        },
        {
          'text':
              'I was working hard to ensure adequate nutrient intake and balance, but have not been prioritizing it lately.',
          'score': 6,
          'yesFlag': false
        },
        {'text': 'Previous Question', 'score': 0, 'yesFlag': true},
    ...
    },
    {
      ...
      'answers': [
        ...
        {
          'text':
              'I was getting good quality and good amounts of sleep, but have not been prioritizing it lately.',
          'score': 6,
          'yesFlag': false
        },
        {'text': 'Previous Question', 'score': 0, 'yesFlag': true},
    ...
    },
    {
      ...
      'answers': [
        ...
        {
          'text':
              'I have been interested in learning more about or improving my level of physical activity.',
          'score': 2,
          'yesFlag': false
        },
        {
          'text':
              'I have been thinking about ways to achieve adequate levels of physical activity.',
          'score': 3,
          'yesFlag': false
        },
        {
          'text':
              'I have started improving my level of physical activity in the last six months.',
          'score': 4,
          'yesFlag': false
        },
        {
          'text':
              'I have been ensuring adequate physical activity in my personal life and plan to continue to do so.',
          'score': 5,
          'yesFlag': false
        },
        {
          'text':
              'I was working hard to ensure adequate physical activity, but have not been prioritizing it lately.',
          'score': 6,
          'yesFlag': false
        },
        {'text': 'Previous Question', 'score': 0, 'yesFlag': true},
    ...
    },
    {
      ...
      'answers': [
        {
          'text':
              'I am not interested in learning more about my physical environment and how it can impact my overall wellness .',
          'score': 1,
          'yesFlag': false
        },
        {
          'text':
              'I have been interested in learning more about or improving my physical environment and how it can impact my overall wellness.',
          'score': 2,
          'yesFlag': false
        },
        {
          'text':
              'I have been thinking about ways to achieve a satisfactory physical environment and how it can serve to impact my overall wellness.',
          'score': 3,
          'yesFlag': false
        },
        {
          'text':
              'I have started to make improvements in physical environment and follow strategies to reduce distractions in the last six months.',
          'score': 4,
          'yesFlag': false
        },
        {
          'text':
              'I have been actively monitoring my personal environment to ensure that it supports my health and wellness for over half a year.',
          'score': 5,
          'yesFlag': false
        },
        {
          'text':
              'I was working hard to ensure a satisfactory physical environment, but have not been prioritizing it lately.',
          'score': 6,
          'yesFlag': false
        },
        {'text': 'Previous Question', 'score': 0, 'yesFlag': true},
    ...
    },
    {
      ...
      'answers': [
        {'text': 'Rarely', 'score': 5, 'yesFlag': false},
    ...
    },
    {
      ...
      'answers': [
        ...
        {
          'text':
              'I have been interested in learning more about or improving my personal levels of stress.',
          'score': 2,
          'yesFlag': false
        },
        {
          'text':
              'I have been thinking about ways to achieve adequate stress management.',
          'score': 3,
          'yesFlag': false
        },
        {
          'text':
              'I have started improving my management of stress in the last six months.',
          'score': 4,
          'yesFlag': false
        },
        {
          'text':
              'I have been managing my stress levels for over six months and plan to continue to do so.',
          'score': 5,
          'yesFlag': false
        },
        {
          'text':
              'I was working hard to ensure adequate stress management, but have not been prioritizing it lately.',
          'score': 6,
          'yesFlag': false
        },
        {'text': 'Previous Question', 'score': 0, 'yesFlag': true},
  ...
  void _resetQuiz() {
    //if they choose reset quiz at the end of the survey then everything gets set back to 0 so they can restart the quiz
    setState(() {
      _questionIndex = 0;
      _totalScore = 0;
  ...
  void _answerQuestion(int score, bool yesFlag) {
    ...
    scoreArray[_questionIndex] =
        score; //adds the score to a score Array at the index of the question so each individual score can be looked at
    if (yesFlag) {
      //if they pressed previous- then they can go back a question- the questionIndex goes back one
      setState(() {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: _questionIndex < _questions.length
            ? Quiz(
                //going through the quiz then going to the results
                answerQuestion: _answerQuestion,
                questionIndex: _questionIndex,
                questions: _questions,
              ) //Quiz
            : Result(scoreArray: scoreArray, resetHandler: _resetQuiz),
      ), //Padding
    ); //MaterialApp
  }
}
