...
class _$GLogoutReq extends GLogoutReq {
  ...
  factory _$GLogoutReq([void Function(GLogoutReqBuilder)? updates]) =>
      (new GLogoutReqBuilder()..update(updates)).build();
  ...
  _$GLogoutReq._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(vars, 'GLogoutReq', 'vars');
    BuiltValueNullFieldError.checkNotNull(operation, 'GLogoutReq', 'operation');
    BuiltValueNullFieldError.checkNotNull(
        executeOnListen, 'GLogoutReq', 'executeOnListen');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GLogoutReq')
          ..add('vars', vars)
    ...
    try {
      _$result = _$v ??
          new _$GLogoutReq._(
              ...
              operation: BuiltValueNullFieldError.checkNotNull(
                  operation, 'GLogoutReq', 'operation'),
              requestId: requestId,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GLogoutReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
